...
; L'envoi de courriel ne fonctionne que sans gnus-emacs (probleme avec netrc)
...
(defun frame-setup ()
  ...
  (if (< x-width 1920)
    ...
    (if (< x-width 3840)
      (progn (set-face-font 'default "7x14") (setq x-font 7) (setq y-font 14))
      (progn
