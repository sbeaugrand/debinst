...
function patteL1(L) =
  (L==60)?14:(L==80)?18:(L==100)?26:(L==120)?33:(L==140)?46:55;
function patteL2(L) =
  (L==60)?19:(L==80)?28:(L==100)?27:(L==120)?36:30;
module patte(L) {
  l=patteP(L);
  d=4.5;
  e=2;
...
function equerreL1(L) = (L==30)?10:(L==40)?12:
  (L==80)?17:(L==100)?26:(L==120)?30:16;
function equerreL2(L) = (L==30)?14:(L==40)?22:
  (L==80)?55:(L==100)?60:(L==120)?77:(L==50)?25:(L==60)?35:46;
module equerre(L) {
  l=equerreP(L);
  d=4.5;
  e=2;
