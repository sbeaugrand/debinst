...
\begin{axis}[
    ...
    legend columns=5]
    \addplot[blue]
     table[x=Time, y=V/entree, col sep=space] {schmittTrigger940Meg.dat};
    \addplot[green]
     table[x=Time, y=V/diviseur, col sep=space] {schmittTrigger940Meg.dat};
    \addplot[red]
     table[x=Time, y=V/bascule, col sep=space] {schmittTrigger940Meg.dat};
    \addplot[black]
     table[x=Time, y=V/sortie, col sep=space] {schmittTrigger940Meg.dat};
