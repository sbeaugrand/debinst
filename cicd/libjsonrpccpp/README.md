...
localhost> vagrant ssh
 ...
 vagrant1> ARCH=armhf
 vagrant1> mmdebstrap --variant=buildd --architectures=$ARCH stable ~/sbuild/stable-$ARCH.tar.xz --include=automake,cmake,debhelper,fakeroot,pkg-config,lintian,libargtable2-dev,libcurl4-openssl-dev,libjsoncpp-dev,libmicrohttpd-dev
